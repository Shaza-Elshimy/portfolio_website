  ...
  return (
    <section id="about" className="px-4 py-24 text-white sm:px-6">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 md:grid-cols-2">
        ...
        <div className="flex justify-center" data-aos="fade-left"><div className="aspect-square w-40 rounded-full bg-gradient-to-tr from-purple-600 to-blue-500 p-1 sm:w-56 md:w-64"><div className="flex h-full w-full items-center justify-center rounded-full bg-[#0f0f2d]"><img src="/personal.jpg" alt="Portrait of Shaza Hamdy" className="h-full w-full rounded-full object-cover shadow-lg" width="768" height="768" decoding="async" /></div></div></div>
      </div>
