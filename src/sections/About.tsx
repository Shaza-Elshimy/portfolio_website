...
export function About({ onTabChange }: { onTabChange: (tab: ShowcaseTab) => void }) {
  const stats = [
    { label: "Projects", value: projects.length, image: "/stats/code.png", description: "A collection of full-stack and frontend projects built around practical user experiences." },
    { label: "Certificates", value: certifications.length, image: "/stats/award.png", description: "Certified achievements in web development and programming from recognized platforms." },
    { label: "Skills", value: skills.length, image: "/stats/skill.png", description: "Working across modern frontend and backend technologies, from React and TypeScript to Node.js and databases." },
  ];
      ...
      <div className="mx-auto max-w-3xl">
        <div className="space-y-6 text-center" data-aos="fade-up">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/documents/shaza_Hamdy_Mohamed_CV%20.pdf" download className="rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 px-5 py-2 transition duration-300 hover:scale-105">Download CV</a>
