...
export function ProjectTabs({ categories, activeCategory, onChange }: ProjectTabsProps) {
  return (
    <div className="mx-auto mt-8 flex w-fit max-w-full flex-wrap justify-center gap-1.5 rounded-2xl border border-white/15 bg-[#100a32]/80 p-1.5 shadow-lg shadow-black/20 backdrop-blur-md sm:flex-nowrap" role="tablist" aria-label="Project categories">
